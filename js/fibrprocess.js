...
function fibrInit() {
    $.get("https://gitee.com/api/v5/repos/jackiechan/ptepractise/contents/data/fibrallquestions.txt?access_token=c87299575627265144b7db286d3bf673", function (response) {
    ...
    $.get("https://gitee.com/api/v5/repos/jackiechan/ptepractise/contents/data/fibrallquestionsen.txt?access_token=c87299575627265144b7db286d3bf673", function (response) {
...
function fibRCurrentTypedata(param) {
    ...
    switch (type) {
        case "1":
            //C哥蓝色数据
            filePath = "https://gitee.com/api/v5/repos/jackiechan/ptepractise/contents/questions/cge_fib_r_lan.txt?access_token=c87299575627265144b7db286d3bf673"
            break;
        case "2":
            //C哥黄色数据
            filePath = "https://gitee.com/api/v5/repos/jackiechan/ptepractise/contents/questions/cge_fib_r_huang.txt?access_token=c87299575627265144b7db286d3bf673"
            break;
        case "3":
            //C哥白色数据
            filePath = "https://gitee.com/api/v5/repos/jackiechan/ptepractise/contents/questions/cge_fib_r_bai.txt?access_token=c87299575627265144b7db286d3bf673"
            break;
        case "4":
            //C哥所有数据
            filePath = "https://gitee.com/api/v5/repos/jackiechan/ptepractise/contents/questions/cge_fib_r_all.txt?access_token=c87299575627265144b7db286d3bf673"
            break;
        case "5":
            //自定义数据
            filePath = "https://gitee.com/api/v5/repos/jackiechan/ptepractise/contents/questions/cge_fib_r_zidingyi.txt?access_token=c87299575627265144b7db286d3bf673"
            break;
        case "6":
            //自定义数据
            filePath = "https://gitee.com/api/v5/repos/jackiechan/ptepractise/contents/questions/cge_fib_r_zidingyi2.txt?access_token=c87299575627265144b7db286d3bf673"
            break;
        case "7":
            ...
            break;
        case "8":
            filePath = "https://gitee.com/api/v5/repos/jackiechan/ptepractise/contents/questions/xjfib_r_withoutc.txt?access_token=c87299575627265144b7db286d3bf673"
            break
    }
    //当前数据
    if (filePath) {
