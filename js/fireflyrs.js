...
function fireFlyRSInit() {
    $.get("https://gitee.com/api/v5/repos/jackiechan/ptepractise/contents/data/rs/fireflyrs.txt?access_token=c87299575627265144b7db286d3bf673&ref=webversion", function (response) {
