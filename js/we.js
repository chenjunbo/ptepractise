...
function fireflyWeCurrentTypedata(param) {
    ...
    switch (type) {
        case "1":
            //高频预测
            filePath = getGitContentPre()+"/questions/we/fireflyweprediction.txt"+getGitContentAccess()
            break;
        case "2":
...
function fireFlyWeTranslateData(fireflyWeData,params){
    ...
    var text = "";
    var title = "<div class=\"layui-form-item\"><div class=\"layui-inline\"><label  style=\"white-space:nowrap\">第" + (weIndex + 1) + "题/共" + (weCurrentList.length) + "题, 题号:" + num + "&nbsp;&nbsp;" + name +  "&nbsp;&nbsp;</label><div class=\"layui-inline\"><span style=\"color: red\" id=\"timer\"></span></div></div></div>"
