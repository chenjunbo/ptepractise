...
function fibrwTranslateData(fibrwData) {
    ...
    var title = "<div class=\"layui-form-item\"><label class=\"layui-form-label\" style=\"white-space:nowrap\">第" + (index + 1) + "题/共" + (currentList.length) + "题, 题号:" + num + "&nbsp;&nbsp;" + nameWithoutNum +"&nbsp;&nbsp;<span style=\"color: red\" id=\"timer\"></span>"+ "</label></div>"
