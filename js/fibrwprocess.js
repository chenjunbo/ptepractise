...
function fibRwCurrentTypedata(param) {
    ...
    switch (type) {
        case "1":
            //C哥蓝色数据
            filePath = "https://gitee.com/api/v5/repos/jackiechan/ptepractise/contents/questions/cge_fib_rw_lan.txt?access_token=2fd4d53480c117fa597505cebeceee9d"
            break;
        case "2":
            //C哥黄色数据
            filePath = "https://gitee.com/api/v5/repos/jackiechan/ptepractise/contents/questions/cge_fib_rw_huang.txt?access_token=2fd4d53480c117fa597505cebeceee9d"
            break;
        case "3":
            //C哥白色数据
            filePath = "https://gitee.com/api/v5/repos/jackiechan/ptepractise/contents/questions/cge_fib_rw_bai.txt?access_token=2fd4d53480c117fa597505cebeceee9d"
            break;
        case "4":
            //C哥所有数据
            filePath = "https://gitee.com/api/v5/repos/jackiechan/ptepractise/contents/questions/cge_fib_rw_all.txt?access_token=2fd4d53480c117fa597505cebeceee9d"
            break;
        case "5":
            //自定义数据
            filePath = "https://gitee.com/api/v5/repos/jackiechan/ptepractise/contents/questions/cge_fib_rw_zidingyi.txt?access_token=2fd4d53480c117fa597505cebeceee9d"
            break;
        case "6":
            //自定义数据
...
function createFibRwPdfHtml(parmas, serNum, fibrwdata) {
    ...
    $(analysispre).attr("style", "font-size: large;");
