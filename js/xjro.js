...
function xjroTranslateData(xjrodata) {
    ...
    $("#parasdiv").html("")
    $("#resultdiv").html("")
    var title = "<div class=\"layui-form-item\" id='biaotiquyu'><label class=\"layui-form-label\" style=\"white-space:nowrap\">第" + (xjroindex + 1) + "题/共" + (currentROList.length) + "题, 题号:" + num + "&nbsp;&nbsp;" + nameWithoutNum + "&nbsp;&nbsp;</label><div class=\"layui-inline\"><span style=\"color: red\" id=\"timer\"></span></div></div>";
